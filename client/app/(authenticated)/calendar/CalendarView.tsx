...
export interface CalendarCard {
    ...
    content: string;
    deadline: string;
    board: { title: string; color: string | null };
}
...
export function CalendarView({ initialCards }: CalendarViewProps) {
    ...
    const getCardsForDay = (day: Date) => {
        return initialCards.filter(card => isSameDay(parseISO(card.deadline), day));
    };
